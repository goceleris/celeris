...
//     value is treated as "auto" and logs a warning. Whether "auto" should keep enabling it is
//     an open measurement, owned by celeris#585 (SEND_ZC on/off A/B on the real fabric).
//
